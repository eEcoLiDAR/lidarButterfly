...
for (i in seq_len(nrow(boundary_pertransect))) {
  ...
  boundary_pertransect_sel$xmin=boundary_pertransect_sel$xmin-250
  boundary_pertransect_sel$xmax=boundary_pertransect_sel$xmax+250
  boundary_pertransect_sel$ymin=boundary_pertransect_sel$ymin-250
  boundary_pertransect_sel$ymax=boundary_pertransect_sel$ymax+250
...
write.table(forpoly, file = "boundaries_pertransects_wkt_250.csv",row.names=FALSE,col.names=TRUE,sep=",")
